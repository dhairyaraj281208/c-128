...
browser = webdriver.Chrome(
    "C:\\Users\\Dhairya\\Desktop\\python\\c 128\\chromedriver.exe")
browser.get(START_URL)
time.sleep(10)
headers = ["Star","Constellation","Right ascension", 'Declination'	'App.mag.', "Distance",
           "Spectral type", "Brown dwarf", "Mass", "Radius", "Orbital period", "Semimajor axis", "Ecc.", "Discovery year"]
planet_data = []
new_planet_data = []
...
def scrape():
    for i in range(1, 430):
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "exoplanet"}):
            ...
            temp_list.append("https://en.wikipedia.org/wiki" +
